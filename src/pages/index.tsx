      ...
      <main>
        ...
        <div className="mt-10 flex items-center gap-2">
          ...
          <strong className="text-gray-100 text-xl">
            <span className="text-ignite-500">+{props.userCountResponse}</span>{" "}
        ...
        <form onSubmit={createPool} className="mt-10 flex gap-2">
          ...
          />
          <button
            className="bg-yellow-500 px-6 py-4 rounded font-bold text-gray-900 hover:bg-yellow-700 transition-colors"
            type="submit"
          >
            CRIAR MEU BOLÃO
          </button>
        ...
        <div className="mt-10 pt-10 border-t text-gray-100 border-gray-600 flex justify-between">
